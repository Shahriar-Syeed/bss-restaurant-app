  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute -right-1 sm:right-1 md:right-2 top-0">{cartItems?.items.reduce((acc,curr)=>acc=acc+1,0)}</span>
      </Button>
      <div
      ...
      >
        ...
        <Button className="button button-primary rounded-lg w-full py-2 font-bold" onClick={()=>sentOrder(cartItems)}>
          Confirm Order
        </Button>
        </div>
      </div>
